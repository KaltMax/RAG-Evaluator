...
function Header() {
  return (
    <header className="bg-[#181818] border-b border-gray-800 text-white shadow-lg min-h-16 flex flex-wrap items-center justify-between px-6 py-2 gap-4 relative z-10">
